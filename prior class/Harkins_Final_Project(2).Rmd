...
pi_results_min_HT1 = ode(init_vals, times, pi_model_HT1, fit0_HT1$par) # fit0_HT1$par
...
fit0_HT2 = optim(params_HT2, rss_pi_HT2, data=observed_df$green_data, control=list(maxit=10000))
#fit0_HT2$par
#fit0$convergence
...
rss_pi_HT2(fit0_HT2$par,observed_df$green_data )
```
...
pi_results_min_HT2 = ode(init_vals, times, pi_model_HT2, fit0_HT2$par)
...
fit_all_HT3 = mle2(HT3_nll, 
               start=list(beta = start_params[1], 
                          ...
                          sigma = 0.1),
               method="L-BFGS-B",
               lower=c(0, -0.5, 0, 0, 0, 0, 0),
               upper=c(3,3,3,3,3,3,3))
...
pi_results_min_HT1_car_cap = ode(init_vals, times, pi_model_HT1_car_cap, fit3_HT1_car_cap$par)
...
pi_results_min_HT3 = ode(init_vals, times, pi_model_HT3_car_cap, fit3_HT3_car_cap$par)
