...
posterior_diff_y2 =  (rbinom(length(samples_supp_y2), size=15, prob=samples_supp_y2) - rbinom(length(samples_no_supp_y2), size=15, prob=samples_no_supp_y2) )/15


posterior_diff_y1 =  (rbinom(length(samples_supp_y1), size=15, prob=samples_supp_y1) - rbinom(length(samples_no_supp_y1), size=15, prob=samples_no_supp_y1) )/15
...
```{r}
bounds_y1 = quantile(posterior_diff_y1, c(0.025, 0.975))
print(bounds_y1)
bounds_y2 = quantile(posterior_diff_y2, c(0.025, 0.975))
print(bounds_y2)
```
